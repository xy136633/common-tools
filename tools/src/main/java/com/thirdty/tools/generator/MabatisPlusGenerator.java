package com.thirdty.tools.generator;
...
public class MabatisPlusGenerator {
	...
	// 生成文件所在项目路径
	private static String baseProjectPath = "D:\\code\\069\\demo";

	// 基本包名
	private static String basePackage = "com.kindo.hysj";
	// 作者
	private static String authorName = "";
	// 要生成的表名
	private static String[] tables = { "chs_hysj_drg","chs_hysj_adrg" };
//	private static String[] tables = { "kindo_cbr","kindo_jg","kindo_jsjhb","kindo_ks","kindo_mzdj","kindo_mzfymx"
//			,"kindo_mzhzzd","kindo_mzjs","kindo_rydj","kindo_ybzd","kindo_yp","kindo_ys","kindo_zl","kindo_zyfymx"
//			,"kindo_zyhzzd","kindo_zyjs" };
	// table前缀
	// private static String prefix="t_";

	// 数据库配置四要素
	private static String driverName = "com.mysql.jdbc.Driver";
	private static String url = "jdbc:mysql://192.168.1.31:3306/ph_mqas_069?useUnicode=true&characterEncoding=utf8";
	private static String username = "ph_mqas_069";
	private static String password = "Ph_mqas_069";
	...
	public static void main(String[] args) {
		...
		gen.setPackageInfo(new PackageConfig()
				...
				.setEntity("vo").setMapper("dao").setService("dataInsert").setServiceImpl("impl")
				.setXml("mapper"));
